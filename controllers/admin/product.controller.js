...
export const deleteVariantImage = asyncHandler(async (req, res) => {
  // Images are now deleted only via the edit product form submission (deferred deletion).
  return res.status(400).json({ success: false, message: "Use the edit product form to manage images." });
});

// @desc    Replace a variant image
export const replaceVariantImage = asyncHandler(async (req, res) => {
  // Images are now managed only via the edit product form submission (deferred).
  return res.status(400).json({ success: false, message: "Use the edit product form to manage images." });
});
